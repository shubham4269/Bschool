            ...
            <section className="section" id="about-process" style={{ background: 'white' }}>
                <div className="container">
                    <div className="about-content-section reverse">
                        <div className="about-image-box" style={{ background: 'linear-gradient(135deg, #0ea5e9, #06b6d4)' }}>
                            <div className="about-image-icon">📈</div>
                        ...
                        <div className="about-text">
                            ...
                            <div className="about-list">
                                <div className="about-list-item">
                                    <div className="about-list-icon" style={{ background: 'var(--accent-100)', color: 'var(--accent-600)' }}>1</div>
                                    <strong>Profile Assessment</strong> — Free comprehensive evaluation of your profile
                                </div>
                                <div className="about-list-item">
                                    <div className="about-list-icon" style={{ background: 'var(--accent-100)', color: 'var(--accent-600)' }}>2</div>
                                    <strong>College Shortlisting</strong> — Curated list of best-fit B-schools
                                </div>
                                <div className="about-list-item">
                                    <div className="about-list-icon" style={{ background: 'var(--accent-100)', color: 'var(--accent-600)' }}>3</div>
                                    <strong>Application & Prep</strong> — SOP, LOR, form filling, and interview coaching
                                </div>
                                <div className="about-list-item">
                                    <div className="about-list-icon" style={{ background: 'var(--accent-100)', color: 'var(--accent-600)' }}>4</div>
                                    <strong>Admission & Beyond</strong> — Securing your seat and ongoing career support
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section className="stats-bar" id="about-stats">
                <div className="stats-bar-inner">
                    ...
                    <div className="stat-item fade-in fade-in-delay-2">
                        ...
                        <div className="stat-label">B-School Partners</div>
                    </div>
